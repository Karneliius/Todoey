...
final class SectionViewController: UIViewController {
    ...
    private lazy var sectionTableView : UITableView = {
        ...
        myTableView.register(TodoeyTableViewCell.self, forCellReuseIdentifier: TodoeyTableViewCell.IDENTIFIER)
        return myTableView
    }()
...
extension SectionViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: TodoeyTableViewCell.IDENTIFIER) as! TodoeyTableViewCell
